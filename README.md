...
- **Nguồn Dữ liệu Backfill cho Streaming:**
    ...
    - *Phục hồi dữ liệu trong ngày (Intraday gap):* Khi dữ liệu chưa kịp vào MinIO, script tự động dự phòng bằng cách gọi tính năng "Past Hours" của API (như trong Open-Meteo) để điền bù, đảm bảo Dashboard luôn liền mạch.